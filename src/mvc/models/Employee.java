...
public class Employee {
		...
		public Employee(int employeeNumber, String firstName, String lastName,
			...
			this(employeeNumber,firstName,lastName,houseNumber,postCode,nationalInsuranceNumber);
		...
		public Employee(int employeeNumber, String firstName, String lastName,
				...
				String nationalInsuranceNumber, float startingSalary,
				String department) {
			this(employeeNumber,firstName,lastName,houseNumber,postCode,nationalInsuranceNumber,startingSalary);
